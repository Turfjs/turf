 ...
 *
 * `../center` finds the simple center of a dataset, by finding the
 ...
 * farthest south.
 *
 * `../center-of-mass` imagines that the dataset is a sheet of paper.
 * The center of mass is where the sheet would balance on a fingertip.
 *
 * `../center-mean` takes the averages of all the coordinates and
 * produces a value that respects that. Unlike `../center`, it is
 ...
 *
 * `../center-median` takes the mean center and tries to find, iteratively,
 * a new point that requires the least amount of travel from all the points in
 * the dataset. It is not as sensitive to outliers as `../center-mean`, but it is
 ...
 * Economics,” _Journal of Regional Science_ 4, no. 2 (1962),
 * doi{@link https, Gerald M. Barber, and David L. Rigby, _Elementary
 * Statistics for Geographers_, 3rd ed., New York, 2009, 150–151.
 *
 * @name centerMedian
