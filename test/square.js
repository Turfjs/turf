...
describe('square', function(){
  it('should return a bbox representing the smallest square that contains the input vertical bbox', function(done){
    var bbox = [0,0,5,10]
    var syncSquare = t.square(bbox, function(err, square){
      if(err) throw err
      square.should.be.ok
    ...
    syncSquare.should.be.ok;
    _.isEqual(syncSquare,[-2.5, 0, 7.5, 10]).should.be.true
    done();
  })
  it('should return a bbox representing the smallest square that contains the input horizontal bbox', function(done){
    ...
    syncSquare.should.be.ok;
    _.isEqual(syncSquare,[0, -2.5, 10, 7.5]).should.be.true;
    done();
  })
}) 