import snappedPointOnRoute from "./index";
...
snappedPointOnRoute(multiLine, pt);
snappedPointOnRoute(line.geometry, pt);
snappedPointOnRoute(multiLine.geometry, pt);
snappedPointOnRoute(line, pt, { units: "miles" });

// Output can be used as Input
const output = snappedPointOnRoute(line, pt);
snappedPointOnRoute(line, output);
