...
const snappedPointOnRoute = require("./index").default;
...
test("turf-snapped-point-on-route - first point", (t) => {
...
test("turf-snapped-point-on-route - points behind first point", (t) => {
  const line = lineString([
    [-122.457175, 37.720033],
    [-122.457175, 37.718242],
  ]);
...
test("turf-snapped-point-on-route - points in front of last point", (t) => {
  const line = lineString([
...
test("turf-snapped-point-on-route - points on joints", (t) => {
  const lines = [
    lineString([
      [-122.456161, 37.721259],
      [-122.457175, 37.720033],
...
test("turf-snapped-point-on-route - points on top of line", (t) => {
  const line = lineString([
    [-0.109198, 51.522042],
    [-0.10923, 51.521942],
    [-0.109165, 51.521862],
  ...
  for (let i = 0; i < 10; i++) {
    ...
    const snapped = snappedPointOnRoute(line, pt, { units: "miles" });
...
test("turf-snapped-point-on-route - point along line", (t) => {
  const line = lineString([
    [-122.457175, 37.720033],
    [-122.457175, 37.718242],
  ]);
...
test("turf-snapped-point-on-route - points on sides of lines", (t) => {
  const line = lineString([
    [-122.456161, 37.721259],
    [-122.457175, 37.718242],
  ]);
...
test("turf-snapped-point-on-route - check dist and index", (t) => {
  const line = lineString([
    [-92.090492, 41.102897],
    [-92.191085, 41.079868],
    [-92.228507, 41.056055],
...
test("turf-snapped-point-on-route -- Geometry Support", (t) => {
  const pt = point([7, 55]);
  const line = lineString([
    [7, 50],
    [8, 50],
