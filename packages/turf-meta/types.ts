...
const multiLine = multiLineString([[[0, 0], [1, 1], [0, 1], [0, 0]], [[2, 2], [3, 3]]])
...
// segmentEach
meta.lineEach(line, () => {})
meta.lineEach(line, previousValue => previousValue)
meta.lineEach(line, (previousValue, currentSegment) => currentSegment)
meta.lineEach(multiLine, (previousValue, currentSegment) => currentSegment)
meta.lineEach(multiLine, (previousValue, currentSegment, currentIndex) => currentSegment)
meta.lineEach(poly, (previousValue, currentSegment) => currentSegment)
meta.lineEach(poly, (previousValue, currentSegment, currentIndex) => currentSegment)
meta.lineEach(multiPoly, (previousValue, currentSegment, currentIndex, currentSubIndex) => currentSegment)

// segmentReduce
meta.lineReduce(line, () => {})
meta.lineReduce(line, previousValue => previousValue)
meta.lineReduce(line, (previousValue, currentSegment) => currentSegment)
meta.lineReduce(line, (previousValue, currentSegment) => currentSegment, 0)
meta.lineReduce(multiLine, (previousValue, currentSegment) => currentSegment)
meta.lineReduce(multiLine, (previousValue, currentSegment, currentIndex) => currentSegment)
meta.lineReduce(poly, (previousValue, currentSegment) => currentSegment)
meta.lineReduce(poly, (previousValue, currentSegment, currentIndex) => currentSegment)
meta.lineReduce(poly, (previousValue, currentSegment, currentIndex) => currentSegment, 1)
meta.lineReduce(multiPoly, (previousValue, currentSegment, currentIndex, currentSubIndex) => currentSegment)
meta.lineReduce(multiPoly, (previousValue, currentSegment, currentIndex, currentSubIndex) => currentSegment, 1)
