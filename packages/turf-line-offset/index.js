...
module.exports = function (line, offset, units) {
    ...
    var finalCoords = segments.map(function (segment, index) {
      return segment[0];
    })
...
function processSegment (point1, point2, offset) {
  ...
  var offsetPixels = offset

  var out1x = point1[0] + offsetPixels * (point2[1] - point1[1]) / L
  var out2x = point2[0] + offsetPixels * (point2[1] - point1[1]) / L
  var out1y = point1[1] + offsetPixels * (point1[0] - point2[0]) / L
  var out2y = point2[1] + offsetPixels * (point1[0] - point2[0]) / L
