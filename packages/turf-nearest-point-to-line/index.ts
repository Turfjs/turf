 ...
 * @param {Units} [options.units='kilometers'] unit of the output distance property. Supports all valid Turf {@link https://github.com/Turfjs/turf/blob/master/packages/turf-helpers/README_UNITS.md Units}.
