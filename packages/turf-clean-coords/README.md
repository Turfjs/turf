...
*   `geojson` **[GeoJSON][1]** Any valid GeoJSON type
*   `options` **[Object][2]** Optional parameters (optional, default `{}`)

    *   `options.mutate` **[boolean][3]** allows GeoJSON input to be mutated (optional, default `false`)
    *   `options.epsilon` **[number][4]?** Fractional number to compare with the cross product result. Useful for dealing with floating points such as lng/lat points
...
Returns **([Geometry][5] | [Feature][6])** the cleaned input Feature/Geometry
