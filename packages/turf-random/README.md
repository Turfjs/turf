...
*   `options` **[Object][6]** Optional parameters (optional, default `{}`)
    ...
    *   `options.distanceUnits` **Units** Supports all valid distance Turf [Units][10]. (optional, default `'degrees'`)
...
Returns **[FeatureCollection][7]<[Polygon][11]>** GeoJSON FeatureCollection of polygons

## randomLineString

Returns a random [LineString][12].
...
*   `options` **[Object][6]** Optional parameters (optional, default `{}`)
    ...
    *   `options.angleUnits` **Units** Supports all valid angular Turf [Units][10]. (optional, default `'radians'`)
...
[10]: https://turfjs.org/docs/api/types/Units
